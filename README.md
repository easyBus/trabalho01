...
> O sistema proposto para “easyBus” conterá as informações aqui detalhadas. Da Empresa serão armazenados o número de linhas (quantidade trajetos feitos pelos coletivos), e o número de ônibus disponíveis para a circulação. Das Linhas serão armazenados o número delas, os pontos de origem e destino, os pontos relevantes que ele passa, a média de tempo de viagem, de acordo com o horário de saída, e a média da quantidade de passageiros por ônibus de acordo com o horário de saída. Dos ônibus serão armazenados o tipo o ônibus(articulado, micro-ônibus, seletivo, ônibus comum), a quantidade de pessoas sentadas, a quantidade de pessoas em pé e a placa do ônibus. Os ônibus não tem linhas específicas e podem ser realocados de acordo com a necessidade da população, podem estar circulando no máximo a quantidade de ônibus necessários, para caso haja algum imprevisto em alguma frota ativa, como por  exemplo: acidentes, manutenção, greves, trânsito.


### 4.RASCUNHOS BÁSICOS DA INTERFACE (MOCKUPS)<br>
Neste ponto a codificação não e necessária, somente as ideias de telas devem ser desenvolvidas. O princípio aqui é pensar na criação da interface para identificar possíveis informações a serem armazenadas e/ou descartadas <br>

![Alt text](https://github.com/easyBus/trabalho01/blob/master/imagens/homepage-easyBus.png?raw=true "Title")
...
![Alt text](https://github.com/easyBus/trabalho01/blob/master/imagens/modelo_conceitual.png?raw=true "Modelo Conceitual")
